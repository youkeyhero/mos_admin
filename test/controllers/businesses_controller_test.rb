...
class BusinessesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create business" do
    assert_difference('Business.count') do
      post businesses_url, params: { business: { category: @business.category, cd: @business.cd, name: @business.name } }
    end
  ...
  test "should update business" do
    patch business_url(@business), params: { business: { category: @business.category, cd: @business.cd, name: @business.name } }
